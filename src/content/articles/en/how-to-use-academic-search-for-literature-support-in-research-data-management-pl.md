---
title: "How to Use Academic Search for Literature Support in Research Data Management Planning"
description: "科研数据管理（RDM）正成为全球资助机构的硬性要求。英国研究与创新署（UKRI）自2022年起要求所有新项目提交数据管理计划，而中国国家自然科学基金委员会在2023年发布的《关于科学数据管理的政策》中明确，受资助项目须在结题前提交数据管理计划。然而，许多研究生和学者面临的现实是：在撰写数据管理计划时，如何高效检索…"
category: "How"
pubDatetime: '2026-05-06T01:42:38Z'
publishDate: '2026-05-06T01:42:38Z'
modDatetime: '2026-05-06T01:42:38Z'
readingTime: 3
tags: ["featured"]
---
...
Google Scholar支持布尔运算符AND、OR、NOT，以及字段限定符`intitle:`、`author:`和`source:`。例如，检索“数据管理计划”和“FAIR原则”的交集，可使用：
```
intitle:"data management plan" AND "FAIR principles"
```
返回结果约320条（2024年实测）。更精确的检索式可限定时间范围，如`after:2020`。注意，Google Scholar不支持截词符（如*），因此需手动枚举同义词，例如“research data management” OR “RDM”。
